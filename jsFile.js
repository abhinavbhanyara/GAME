  ...
  if(painted[canvasNumber-1]==false){
    if(turn%2==0){
      ...
      if(f==1){
              ...
              //middle horizontal and verticle
                ...
                //Diagonals
                  ...
                  canvasNumber=1;
                    ...
                    //for player
        //diagonal and middle
        else if(content[0]=='x'&&content[4]=='x'&&content[8]=='0'&&content[2]==''&&content[6]==''){
          canvasNumber=getRandom();
          while(1){
            if(canvasNumber==3||canvasNumber==7)
            break;
            canvasNumber=getRandom();
          }
        }
        else if(content[2]=='x'&&content[4]=='x'&&content[6]=='0'&&content[0]==''&&content[8]==''){
          canvasNumber=getRandom();
          while(1){
            if(canvasNumber==1||canvasNumber==9)
            break;
            canvasNumber=getRandom();
          }
        }
        else if(content[8]=='x'&&content[4]=='x'&&content[0]=='0'&&content[2]==''&&content[6]==''){
          canvasNumber=getRandom();
          while(1){
            if(canvasNumber==3||canvasNumber==7)
            break;
        ...
        else if(content[6]=='x'&&content[4]=='x'&&content[2]=='0'&&content[0]==''&&content[8]==''){
          canvasNumber=getRandom();
          while(1){
            if(canvasNumber==1||canvasNumber==9)
            break;
